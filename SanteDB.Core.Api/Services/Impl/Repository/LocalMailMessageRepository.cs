...
namespace SanteDB.Core.Services.Impl.Repository
{
        ...
        IRepositoryService<MailMessage>
    {
        ...
        /// </summary>
        private readonly Tracer traceSource = Tracer.GetTracer(typeof(LocalMailMessageRepository));
        ...
        /// </summary>
        public LocalMailMessageRepository(ILocalizationService localizationService, IPolicyEnforcementService pepService, IDataPersistenceService<MailMessage> dataPersistenceService, ISecurityRepositoryService securityRepositoryService, IRoleProviderService roleProviderService)
        {
        ...
        {
            this.m_pepService.Demand(PermissionPolicyIdentifiers.Login);

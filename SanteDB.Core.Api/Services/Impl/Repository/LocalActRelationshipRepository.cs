...
namespace SanteDB.Core.Services.Impl.Repository
{
    ...
    /// </summary>
    public class LocalActRelationshipRepository : GenericLocalRepository<ActRelationship>
    {
        /// <summary>
        /// Entity relationship repository
        /// </summary>
        public LocalActRelationshipRepository(IPolicyEnforcementService policyService, IDataPersistenceService<ActRelationship> dataPersistence, IPrivacyEnforcementService privacyService = null) : base(policyService, dataPersistence, privacyService)
        {
        }
        ...
        /// </summary>
        public override ActRelationship Insert(ActRelationship data)
        {
        ...
        public override ActRelationship Save(ActRelationship data)
        {
            // force set the version sequence
            if (data.EffectiveVersionSequenceId == null)
            {

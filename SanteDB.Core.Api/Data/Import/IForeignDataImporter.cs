...
namespace SanteDB.Core.Data.Import
{
    ...
    public interface IForeignDataImporter
    {
        ...
        /// <param name="parameters">The parameters for the import operation</param>
        /// <param name="sourceReader">The source reader</param>
        /// <returns>The detected issues</returns>
        IEnumerable<DetectedIssue> Validate(ForeignDataObjectMap foreignDataObjectMap, IDictionary<string, string> parameters, IForeignDataReader sourceReader);
        ...
        IEnumerable<DetectedIssue> Import(ForeignDataObjectMap foreignDataObjectMap, IDictionary<string, string> parameters, IForeignDataReader sourceReader, IForeignDataWriter rejectWriter, TransactionMode transactionMode);

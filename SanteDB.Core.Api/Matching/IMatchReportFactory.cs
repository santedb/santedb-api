...
namespace SanteDB.Core.Matching
{
    ...
    public interface IMatchReportFactory
    {
        ...
        /// <param name="diagnosticInformation">The diagnostic session captured</param>
        object CreateMatchReport(Type inputType, object input, IEnumerable<IRecordMatchResult> matches, IRecordMatchingDiagnosticSession diagnosticInformation = null);
        ...
        /// <param name="matches">The matches</param>
        /// <returns>A serializable object representing the match reports</returns>
        object CreateMatchReport<T>(T input, IEnumerable<IRecordMatchResult<T>> matches, IRecordMatchingDiagnosticSession diagnosticInformation = null)
